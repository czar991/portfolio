...
export default function Header() {
  ...
  return (
    <header className='z-50 relative'>
      <motion.div
        className='flex fixed top-0 left-1/2 -translate-x-1/2 py-2 w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[8px] sm:top-6 sm:h-[52px] sm:max-w-screen-md sm:py-0 sm:rounded-full'
